    ...
    <Popover.Root>
      <Popover.Trigger
        className={clsx('w-10 h-10 rounded-lg', {
          ...
          'bg-violet-900 border-biolet-700': completedPercentage > 0 && completedPercentage < 20,
          'bg-violet-800 border-biolet-700': completedPercentage >= 20 && completedPercentage < 50,
          'bg-violet-700 border-biolet-600': completedPercentage >= 40 && completedPercentage < 60,
          'bg-violet-600 border-biolet-500': completedPercentage >= 60 && completedPercentage < 80,
          'bg-violet-500 border-biolet-400': completedPercentage >= 80,
        })} />
